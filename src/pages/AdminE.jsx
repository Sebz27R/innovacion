    ...
    return (
        <div className="flex flex-col items-center p-10">
          <div className="text-center">
            <div className="ml-[105px] text-6xl mb-4">
              <FaBuilding />
            </div>
            ...
            <div className="mt-6 flex justify-between w-72">
              ...
              <input type="text" className="border p-2 w-40" placeholder="correo.registrado@empresa" />
            </div>
            ...
            {/* Subir inventario */}
            <div className="mt-6 flex justify-between w-72">
              <h2 className='font-bold'>Subir inventario</h2>
